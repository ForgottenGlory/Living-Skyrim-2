...
1. Download the latest version of [Wabbajack](https://github.com/wabbajack-tools/wabbajack/releases) and the latest [Living Skyrim Installer](https://drive.google.com/file/d/1AiRPwRQNlFfdcF6xRmPDzhoHOyqclh-N/view?usp=sharing). Do not run anything until instructed to do so. Make sure you are using the latest version of Wabbajack or else Wabbajack will report a corrupted modlist.
